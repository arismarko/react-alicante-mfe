...
const foundDirname = !regularDirname && findSync(process.cwd(), [
    "itemcatalogue/prisma/generated/client1",
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/aristosmarkogiannakis/Projects/conference/alicante-microfrontends-demo2/itemcatalogue/prisma/generated/client1",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "itemcatalogue/prisma/generated/client1/libquery_engine-darwin-arm64.dylib.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "itemcatalogue/prisma/generated/client1/schema.prisma")
