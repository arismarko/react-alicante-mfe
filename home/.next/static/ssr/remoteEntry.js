...
var moduleMap = {
	"./nav": () => {
		return __webpack_require__.e("components_nav_js").then(() => (() => ((__webpack_require__(/*! ./components/nav.js */ "./components/nav.js")))));
	},
	"./home": () => {
		return __webpack_require__.e("async-pages_index_js").then(() => (() => ((__webpack_require__(/*! ./async-pages/index.js */ "./async-pages/index.js")))));
	},
	"./pages-map": () => {
		return __webpack_require__.e("pages-map_js").then(() => (() => ((__webpack_require__(/*! ./pages-map.js */ "./pages-map.js")))));
	}
};
...
/******/ 	(() => {
/******/ 		var chunkMapping = {
/******/ 			"webpack_container_remote_itemcatalogue_title": [
/******/ 				"webpack/container/remote/itemcatalogue/title"
/******/ 			]
/******/ 		};
...
/******/ 				} else {
/******/ 					if("webpack_container_remote_itemcatalogue_title" != chunkId) {
...
/******/ 								console.log('before remote var creation', {"home":"home@http://localhost:3001/_next/static/ssr/remoteEntry.js","orders":"orders@http://localhost:3002/_next/static/ssr/remoteEntry.js","itemcatalogue":"itemcatalogue@http://localhost:3000/_next/static/ssr/remoteEntry.js"})
/******/ 								var remotes = {"home":"home@http://localhost:3001/_next/static/ssr/remoteEntry.js","orders":"orders@http://localhost:3002/_next/static/ssr/remoteEntry.js","itemcatalogue":"itemcatalogue@http://localhost:3000/_next/static/ssr/remoteEntry.js"};
/******/ 								console.log('remotes in chunk load',remotes)
/******/ 								console.log('global.REMOTE_CONFIG',global.REMOTE_CONFIG)
/******/ 								if(global.REMOTE_CONFIG && !global.REMOTE_CONFIG["home"]) {
...
/******/ 								}
/******/ 								var requestedRemote = global.REMOTE_CONFIG["home"]
...
/******/ 	exports.home = __webpack_exports__;
/******/ 	
/******/ })()
;